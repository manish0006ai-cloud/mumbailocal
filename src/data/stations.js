...
export const stations = [
  ...
  { id: 'th_dgh', name: 'Digha Gaon', code: 'DIG', line: 'trans-harbour', platforms: 2, interchange: [], x: 350, y: 405 },
  { id: 'th_arl', name: 'Airoli', code: 'ARL', line: 'trans-harbour', platforms: 2, interchange: [], x: 350, y: 390 },
  { id: 'th_rbd', name: 'Rabale', code: 'RBD', line: 'trans-harbour', platforms: 2, interchange: [], x: 350, y: 365 },
  { id: 'th_ghsl', name: 'Ghansoli', code: 'GHL', line: 'trans-harbour', platforms: 2, interchange: [], x: 350, y: 340 },
  { id: 'th_kpr', name: 'Kopar Khairane', code: 'KPK', line: 'trans-harbour', platforms: 2, interchange: [], x: 350, y: 315 },
  { id: 'th_trb', name: 'Turbhe', code: 'TRB', line: 'trans-harbour', platforms: 2, interchange: ['harbour'], x: 350, y: 290 },
  { id: 'th_jui', name: 'Juinagar', code: 'JUI', line: 'trans-harbour', platforms: 2, interchange: ['harbour'], x: 350, y: 265 },
  { id: 'th_swd', name: 'Sanpada', code: 'SPD', line: 'trans-harbour', platforms: 2, interchange: ['harbour'], x: 350, y: 240 },
  { id: 'th_vsh', name: 'Vashi', code: 'VSH', line: 'trans-harbour', platforms: 2, interchange: ['harbour'], x: 350, y: 215 },
  { id: 'th_nrl', name: 'Nerul', code: 'NRL', line: 'trans-harbour', platforms: 2, interchange: ['harbour'], x: 350, y: 190 },
  { id: 'th_swd2', name: 'Seawoods Darave', code: 'SWD', line: 'trans-harbour', platforms: 2, interchange: ['harbour'], x: 350, y: 165 },
  { id: 'th_cbd', name: 'CBD Belapur', code: 'CBD', line: 'trans-harbour', platforms: 4, interchange: ['harbour'], x: 350, y: 140 },
  { id: 'th_kpr2', name: 'Kharghar', code: 'KPR', line: 'trans-harbour', platforms: 2, interchange: ['harbour'], x: 350, y: 115 },
  { id: 'th_mnsr', name: 'Mansarovar', code: 'MSR', line: 'trans-harbour', platforms: 2, interchange: ['harbour'], x: 350, y: 90 },
  { id: 'th_knj', name: 'Khandeshwar', code: 'KHS', line: 'trans-harbour', platforms: 2, interchange: ['harbour'], x: 350, y: 65 },
  { id: 'th_pnl', name: 'Panvel', code: 'PNL', line: 'trans-harbour', platforms: 6, interchange: ['harbour'], x: 350, y: 40 },
];
